...
func NewCafeRepoImp(postgres *pgxpool.Pool) *CafesRepoImp {
	...
	_, err = postgres.Exec(context.Background(), `INSERT INTO cafes (id, owner_id, name, description, opening_time, closing_time, capacity, phone_number, email, location, province, city, address, categories, amenities, reservation_price)
			VALUES
			(1, 31, 'Bean & Blossom', 'A stylish cafe with a focus on specialty coffees and homemade desserts.', 8, 23, 25, 12345678901, 'beanandblossom@gmail.com', '', 1, 2, '123 Oak Street, Los Angeles, CA', 'Coffee,Desserts', 'وای فای', 15000.0),
			(2, 32, 'Urban Brew Café', 'A cozy cafe offering a variety of teas and snacks.', 9, 23, 30, 23456789012, 'urbanbrewcafe@gmail.com', '', 1, 2, '456 Maple Avenue, Los Angeles, CA', 'Tea,Snacks', 'تلویزیون', 10000.0),
			(3, 33, 'The Coffee Corner', 'An elegant cafe known for its artisan pastries.', 7, 21, 20, 34567890123, 'thecoffeecorner@gmail.com', '', 1, 2, '789 Pine Street, Los Angeles, CA', 'Pastries,Coffee', 'پارکینگ', 20000.0),
			(4, 34, 'Whisk & Sip', 'A modern cafe with a wide selection of vegan options.', 8, 20, 35, 45678901234, 'whiskandsip@gmail.com', '', 1, 2, '321 Birch Avenue, Los Angeles, CA', 'Vegan,Snacks', 'موسیقی زنده', 18000.0),
			(5, 35, 'Café Serenity', 'A family-friendly cafe with a play area for children.', 9, 19, 40, 56789012345, 'cafeserenity@gmail.com', '', 1, 2, '654 Cedar Street, Los Angeles, CA', 'Family,Desserts', 'بردگیم', 12000.0),
			(6, 36, 'Roast & Toast', 'A cafe with a great selection of international cuisines.', 10, 21, 45, 67890123456, 'roastandtoast@gmail.com', '', 1, 2, '987 Willow Lane, Los Angeles, CA', 'International,Main Dish', 'اجازه ورود حیوانات خانگی', 22000.0),
			(7, 37, 'Mocha Mystique', 'A cozy cafe perfect for working or studying.', 8, 22, 30, 78901234567, 'mochamystique@gmail.com', '', 1, 2, '321 Elm Street, Los Angeles, CA', 'Coffee,Snacks', 'قلیان', 17000.0),
			(8, 38, 'Brewed Awakening', 'A rustic cafe with a wide selection of herbal teas.', 9, 23, 25, 89012345678, 'brewedawakening@gmail.com', '', 1, 2, '654 Spruce Avenue, Los Angeles, CA', 'Herbal Tea,Desserts', 'دود آزاد', 16000.0),
			(9, 39, 'The Java Lounge', 'A lively cafe with live music performances.', 7, 24, 50, 90123456789, 'thejavalounge@gmail.com', '', 1, 2, '987 Ash Lane, Los Angeles, CA', 'Coffee,Live Music', 'غذای گیاهی', 25000.0),
