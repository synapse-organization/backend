...
func NewCafeRepoImp(postgres *pgxpool.Pool) *CafesRepoImp {
	...
	_, err = postgres.Exec(context.Background(), `INSERT INTO cafes (id, owner_id, name, description, opening_time, closing_time, capacity, phone_number, email, province, city, address, categories, amenities)
			VALUES
			(1, 12, 'Bean & Blossom', 'A stylish cafe with a focus on specialty coffees and homemade desserts.', 8, 23, 25, 12345678901, 'beanandblossom@gmail.com', '', 1, 2, '123 Oak Street, Los Angeles, CA', 'Coffee,Desserts', 'وای فای'),
			(2, 13, 'Urban Brew Café', 'A cozy cafe offering a variety of teas and snacks.', 9, 23, 30, 23456789012, 'urbanbrewcafe@gmail.com', '', 1, 2, '456 Maple Avenue, Los Angeles, CA', 'Tea,Snacks', 'تلویزیون'),
			(3, 14, 'The Coffee Corner', 'An elegant cafe known for its artisan pastries.', 7, 21, 20, 34567890123, 'thecoffeecorner@gmail.com', '', 1, 2, '789 Pine Street, Los Angeles, CA', 'Pastries,Coffee', 'پارکینگ'),
			(4, 15, 'Whisk & Sip', 'A modern cafe with a wide selection of vegan options.', 8, 20, 35, 45678901234, 'whiskandsip@gmail.com', '', 1, 2, '321 Birch Avenue, Los Angeles, CA', 'Vegan,Snacks', 'موسیقی زنده'),
			(5, 16, 'Café Serenity', 'A family-friendly cafe with a play area for children.', 9, 19, 40, 56789012345, 'cafeserenity@gmail.com', '', 1, 2, '654 Cedar Street, Los Angeles, CA', 'Family,Desserts', 'بردگیم'),
			(6, 17, 'Roast & Toast', 'A cafe with a great selection of international cuisines.', 10, 21, 45, 67890123456, 'roastandtoast@gmail.com', '', 1, 2, '987 Willow Lane, Los Angeles, CA', 'International,Main Dish', 'اجازه ورود حیوانات خانگی'),
			(7, 18, 'Mocha Mystique', 'A cozy cafe perfect for working or studying.', 8, 22, 30, 78901234567, 'mochamystique@gmail.com', '', 1, 2, '321 Elm Street, Los Angeles, CA', 'Coffee,Snacks', 'قلیان'),
			(8, 19, 'Brewed Awakening', 'A rustic cafe with a wide selection of herbal teas.', 9, 23, 25, 89012345678, 'brewedawakening@gmail.com', '', 1, 2, '654 Spruce Avenue, Los Angeles, CA', 'Herbal Tea,Desserts', 'دود آزاد'),
			(9, 20, 'The Java Lounge', 'A lively cafe with live music performances.', 7, 24, 50, 90123456789, 'thejavalounge@gmail.com', '', 1, 2, '987 Ash Lane, Los Angeles, CA', 'Coffee,Live Music', 'غذای گیاهی'),
			(10, 21, 'Espresso Escape', 'A minimalist cafe with a serene atmosphere.', 8, 21, 15, 12309845678, 'espressoescape@gmail.com', '', 1, 2, '123 Fir Street, Los Angeles, CA', 'Tea,Snacks', 'غذای وگان'),
			(11, 22, 'Crème & Beans', 'A hip cafe with unique and creative drinks.', 9, 22, 35, 23410956789, 'cremeandbeans@gmail.com', '', 1, 2, '456 Cedar Avenue, Los Angeles, CA', 'Drinks,Snacks', 'دسترسی برای معلولان'),
			(12, 23, 'The Daily Grind', 'A cafe offering a great selection of board games.', 10, 20, 30, 34521067890, 'thedailygrind@gmail.com', '', 1, 2, '789 Pine Street, Los Angeles, CA', 'Coffee,Games', 'اتاق جلسه'),
			(13, 24, 'Mellow Brew', 'A cafe with a large outdoor seating area.', 8, 22, 45, 45632178901, 'mellowbrew@gmail.com', '', 1, 2, '321 Birch Avenue, Los Angeles, CA', 'Tea,Snacks', 'فضای نشستن بیرون'),
			(14, 25, 'Café Mirage', 'A pet-friendly cafe with great coffee.', 9, 23, 40, 56743289012, 'cafemirage@gmail.com', '', 1, 2, '654 Cedar Street, Los Angeles, CA', 'Coffee,Snacks', 'اجازه ورود حیوانات خانگی'),
			(15, 26, 'Harvest Brews', 'A cafe with excellent desserts and snacks.', 10, 24, 50, 67854390123, 'harvestbrews@gmail.com', '', 1, 2, '987 Willow Lane, Los Angeles, CA', 'Desserts,Snacks', 'وای فای'),
			(16, 27, 'Java Junction', 'A modern cafe with great food and drinks.', 8, 20, 35, 78965401234, 'javajunction@gmail.com', '', 1, 2, '321 Elm Street, Los Angeles, CA', 'Main Dish,Drinks', 'تلویزیون'),
			(17, 28, 'The Cozy Nook', 'A small cafe with a selection of vegan foods.', 9, 21, 20, 89076512345, 'thecozynook@gmail.com', '', 1, 2, '654 Spruce Avenue, Los Angeles, CA', 'Vegan,Snacks', 'پارکینگ'),
			(18, 29, 'Velvet Roast', 'A cafe with delicious pastries and coffee.', 10, 23, 25, 90187623456, 'velvetroast@gmail.com', '', 1, 2, '987 Ash Lane, Los Angeles, CA', 'Pastries,Coffee', 'موسیقی زنده'),
			(19, 30, 'Caffeine Haven', 'A lively cafe with various entertainment options.', 8, 22, 50, 12398734567, 'caffeinehaven@gmail.com', '', 1, 2, '123 Fir Street, Los Angeles, CA', 'Coffee,Entertainment', 'بردگیم'),
			(20, 31, 'Artisan Aroma', 'A cafe offering a variety of teas and herbal drinks.', 9, 21, 30, 23409845678, 'artisanaroma@gmail.com', '', 1, 2, '456 Cedar Avenue, Los Angeles, CA', 'Herbal Tea,Desserts', 'وای فای'),
			(21, 32, 'Brewed Bliss', 'A rustic cafe with a wide selection of coffees.', 10, 23, 25, 34510956789, 'brewedbliss@gmail.com', '', 1, 2, '789 Pine Street, Los Angeles, CA', 'Coffee,Desserts', 'تلویزیون'),
			(22, 33, 'The Tea Emporium', 'A family-friendly cafe with a variety of snacks.', 8, 22, 40, 45621067890, 'theteaemporium@gmail.com', '', 1, 2, '321 Birch Avenue, Los Angeles, CA', 'Family,Snacks', 'پارکینگ'),
			(23, 34, 'Café Delights', 'A cafe with a great selection of international dishes.', 9, 24, 45, 56732178901, 'cafedelights@gmail.com', '', 1, 2, '987 Willow Lane, Los Angeles, CA', 'International,Main Dish', 'موسیقی زنده'),
			(24, 35, 'Sip & Savor', 'A cozy cafe with excellent coffee and pastries.', 8, 20, 20, 67843289012, 'sipandsavor@gmail.com', '', 1, 2, '321 Elm Street, Los Angeles, CA', 'Coffee,Pastries', 'وای فای'),
			(25, 36, 'The Coffee House', 'A modern cafe with a wide variety of drinks.', 9, 21, 35, 78954390123, 'thecoffeehouse@gmail.com', '', 1, 2, '654 Spruce Avenue, Los Angeles, CA', 'Drinks,Snacks', 'تلویزیون'),
			(26, 37, 'Sweet Aroma Café', 'A family-friendly cafe with a variety of snacks.', 10, 22, 40, 89065401234, 'sweetaromacafe@gmail.com', '', 1, 2, '987 Ash Lane, Los Angeles, CA', 'Family,Snacks', 'اجازه ورود حیوانات خانگی'),
			(27, 38, 'The Rustic Bean', 'A rustic cafe with a wide selection of herbal teas.', 8, 20, 30, 90176512345, 'therusticbean@gmail.com', '', 1, 2, '123 Fir Street, Los Angeles, CA', 'Herbal Tea,Desserts', 'دسترسی برای معلولان'),
			(28, 39, 'Brew & Mingle', 'A lively cafe with various entertainment options.', 9, 23, 50, 12387623456, 'brewandmingle@gmail.com', '', 1, 2, '456 Cedar Avenue, Los Angeles, CA', 'Coffee,Entertainment', 'بردگیم'),
			(29, 40, 'Whispering Pines Café', 'A serene cafe perfect for relaxation.', 10, 21, 25, 23498734567, 'whisperingpinescafe@gmail.com', '', 1, 2, '789 Pine Street, Los Angeles, CA', 'Tea,Snacks', 'موسیقی زنده'),
			(30, 41, 'The Steaming Cup', 'A cozy cafe offering a variety of teas and snacks.', 8, 22, 30, 34509845678, 'thesteamingcup@gmail.com', '', 1, 2, '321 Birch Avenue, Los Angeles, CA', 'Tea,Snacks', 'وای فای')
