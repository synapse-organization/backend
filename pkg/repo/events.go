...
func NewEventRepoImp(postgres *pgxpool.Pool) *EventRepoImp {
	...
	_, err = postgres.Exec(context.Background(), `INSERT INTO events (id, cafe_id, name, description, start_time, end_time, price, capacity, current_attendees, reservable)
			VALUES
			(1, 1, 'Live Jazz Night', 'Enjoy an evening of live jazz music.', '2024-07-10 19:00:00', '2024-07-10 21:00:00', 20.0, 50, 30, true),
			(2, 1, 'Art Exhibition', 'Showcasing local artists.', '2024-07-11 10:00:00', '2024-07-11 17:00:00', 10.0, 100, 60, true),
			(3, 1, 'Coffee Tasting', 'Sample different coffee blends.', '2024-07-12 14:00:00', '2024-07-12 16:00:00', 15.0, 30, 25, true),
			(4, 4, 'Vegan Cooking Workshop', 'Learn to cook vegan dishes.', '2024-07-13 11:00:00', '2024-07-13 14:00:00', 25.0, 20, 18, true),
			(5, 5, 'Kids Storytelling', 'Fun storytelling session for kids.', '2024-07-14 10:00:00', '2024-07-14 11:00:00', 5.0, 40, 35, true),
			(6, 6, 'International Cuisine Night', 'Experience dishes from around the world.', '2024-07-15 18:00:00', '2024-07-15 21:00:00', 30.0, 60, 50, true),
			(7, 7, 'Poetry Reading', 'Enjoy an evening of poetry readings.', '2024-07-16 19:00:00', '2024-07-16 20:30:00', 10.0, 40, 35, true),
			(8, 8, 'Herbal Tea Workshop', 'Learn about and taste herbal teas.', '2024-07-17 15:00:00', '2024-07-17 17:00:00', 12.0, 30, 25, true),
			(9, 9, 'Rock Band Performance', 'Live performance by a local rock band.', '2024-07-18 20:00:00', '2024-07-18 22:00:00', 25.0, 70, 60, true),
			(10, 10, 'Mindfulness Meditation', 'Guided mindfulness meditation session.', '2024-07-19 09:00:00', '2024-07-19 10:00:00', 8.0, 20, 15, true),
			(11, 11, 'Creative Writing Workshop', 'Improve your creative writing skills.', '2024-07-20 14:00:00', '2024-07-20 17:00:00', 20.0, 25, 20, true),
			(12, 12, 'Board Games Night', 'Enjoy an evening of board games.', '2024-07-21 18:00:00', '2024-07-21 21:00:00', 10.0, 40, 35, true),
			(13, 13, 'Outdoor Movie Night', 'Watch a movie under the stars.', '2024-07-22 20:00:00', '2024-07-22 22:00:00', 15.0, 60, 50, true),
			(14, 14, 'Pet Adoption Day', 'Meet and adopt pets in need of homes.', '2024-07-23 10:00:00', '2024-07-23 14:00:00', 0.0, 100, 80, true),
			(15, 15, 'Dessert Baking Class', 'Learn to bake delicious desserts.', '2024-07-24 13:00:00', '2024-07-24 15:00:00', 20.0, 20, 18, true),
			(16, 16, 'Trivia Night', 'Test your knowledge at our trivia night.', '2024-07-25 19:00:00', '2024-07-25 21:00:00', 10.0, 40, 35, true),
			(17, 17, 'Vegan Food Fair', 'Sample and buy various vegan foods.', '2024-07-26 10:00:00', '2024-07-26 14:00:00', 5.0, 50, 45, true),
			(18, 18, 'Live Acoustic Music', 'Enjoy an evening of acoustic music.', '2024-07-27 19:00:00', '2024-07-27 21:00:00', 15.0, 50, 45, true),
			(19, 19, 'Board Game Tournament', 'Compete in our board game tournament.', '2024-07-28 16:00:00', '2024-07-28 19:00:00', 10.0, 30, 25, true),
			(20, 20, 'Herbal Tea Tasting', 'Taste and learn about herbal teas.', '2024-07-29 14:00:00', '2024-07-29 16:00:00', 12.0, 20, 18, true),
			(21, 21, 'Children''s Storytime', 'Fun storytime session for children.', '2024-07-30 10:00:00', '2024-07-30 11:00:00', 5.0, 30, 25, true),
			(22, 22, 'Creative Writing Session', 'Enhance your creative writing skills.', '2024-07-31 15:00:00', '2024-07-31 17:00:00', 20.0, 25, 20, true),
			(23, 23, 'Outdoor Art Class', 'Join us for an outdoor art class.', '2024-08-01 11:00:00', '2024-08-01 13:00:00', 15.0, 20, 18, true),
			(24, 24, 'Pet Adoption Event', 'Adopt pets from local shelters.', '2024-08-02 10:00:00', '2024-08-02 14:00:00', 0.0, 100, 80, true),
			(25, 25, 'Dessert Tasting', 'Taste a variety of desserts.', '2024-08-03 14:00:00', '2024-08-03 16:00:00', 10.0, 30, 25, true),
			(26, 26, 'Live Music Night', 'Enjoy live music performances.', '2024-08-04 19:00:00', '2024-08-04 21:00:00', 20.0, 50, 45, true),
			(27, 27, 'Vegan Cooking Demo', 'Watch a live vegan cooking demo.', '2024-08-05 11:00:00', '2024-08-05 13:00:00', 15.0, 20, 18, true),
			(28, 28, 'Poetry Open Mic', 'Share your poetry at our open mic.', '2024-08-06 18:00:00', '2024-08-06 20:00:00', 10.0, 40, 35, true),
			(29, 29, 'Rock Music Night', 'Enjoy an evening of rock music.', '2024-08-07 20:00:00', '2024-08-07 22:00:00', 25.0, 60, 50, true),
			(30, 30, 'Mindfulness Workshop', 'Learn mindfulness techniques.', '2024-08-08 09:00:00', '2024-08-08 11:00:00', 10.0, 20, 18, true);
	`)
	if err != nil {
